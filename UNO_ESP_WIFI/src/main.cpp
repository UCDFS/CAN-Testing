...
// HTML page with dashboard + CAN log
...
<head>
  ...
  <style>
    ...
    .box { border:1px solid #00e676; border-radius:8px; padding:15px; width:150px; text-align:center; }
...
void loop() {
  ...
  if (Serial.available()) {
    ...
    else if (line.startsWith("STATUS:")) motorStatus = line.substring(7);
